...
const SuccessStories: React.FC<{ stories: SuccessStory[] }> = ({ stories }) => {
  return (
    <section className="relative min-h-screen py-12 overflow-y-auto">
      ...
      >
        <Image
          src="/images/sci-fi.jpg" // Replace with your image path (e.g., from Sanity or public folder)
            ...
            >
              ...
              >
                <Image
                  ...
                  className="w-48 h-48 object-cover rounded-full border border-gray-600"
                />
              </motion.div>
            </motion.div>
          ))}
